    ...
    try {
        ...
        const checkState = setInterval(async () => {
            try {
                ...
                console.log(`[${(0, dayjs_1.default)().format('YYYY-MM-DDTHH:mm:ssZ[Z]')}] project-id: ${projectId}, routine-id: ${routineId}, routine-pipeline-id: ${routinePipelineId}, state: ${pipeline.state}`);
